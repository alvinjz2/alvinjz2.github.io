    ...
    <div class="bg-gradient-to-r from-neutral-100 to-slate-300 h-screen w-full">
      <div class="grid pt-20 ">
        <div class="grid grid-cols-1 place-items-center gap-24">
          <div class="flex flex-row gap-36 items-start">
            <div class="">
              <a rel="noopener noreferrer" target="_blank" href={website_link}>
                <div class="grid bg-white drop-shadow-lg rounded-xl max-w-lg place-items-center pb-3">
                  <div class="grid grid-cols-1 place-items-center max-w-[285px] pt-3 px-3 max-h-fit">
                    <img class="" src={website_mockup} alt="Website" />
                  </div>
                </div>
              </a>
            </div>
